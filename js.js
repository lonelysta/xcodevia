(function () {
    ...
    A.dom.getStyle = function (F, G) {
        ...
        var C = D._styleFixer[G],
            E =
                F.currentStyle || (A.browser.ie ? F.style : getComputedStyle(F, null));
    ...
    A.dom.getPosition = function (D) {
        ...
        if (D.getBoundingClientRect) {
            ...
            if (B.getBoxObjectFor && !I) {
                ...
                if (
                    E.opera > 0 ||
                    (E.isWebkit > 0 && A.dom.getStyle(D, "position") == "absolute")
                ) {
    ...
    A.ui.suggestion._Div = function (V, o, Z, a, X) {
        ...
        function g(C) {
            var B =
                T && typeof C == "number" && typeof T[C] != "undefined" ? T[C] : C;
            V.call("pick_word", B);
        }
        function W() {
            if (S.style.display == "none") {
    ...
    A.ui.suggestion._Suggestion = function (F, B) {
        ...
        if (F.id) {
            ...
            F.id = E.options._inputId =
                E.options.class_prefix + "ipt" + new Date().getTime();
        }
        E._adjustPos = function (S) {
            ...
            var Q = A.dom.getPosition(F),
                L = [Q.top + F.offsetHeight + 1, Q.left + 14, F.offsetWidth + 26];
...
var BaiduSuggestion = (function () {
            ...
            return {
                ...
                getData: function (U) {
                    ...
                    T.src =
                        ...
                        "&p=3&cb=BaiduSuggestion.callbacks.give" +
                        S +
                        "&t=" +
                        V;
                    T.id = "bdSug_script";
                ...
                append_html:
                    "<div style='background:#FFF;line-height:normal;border:0;text-align:right;margin:0;padding:0;'><a class='bdsug_copy' href='http://www.baidu.com/search/sug/sugcode.html' ltarget='_blank' > ٶ         ʾ</a></div>",
                apd_body: true
            };
        },
    ...
    function I(T, Z, S, X) {
        ...
        if (
            G(document.body, "position") == "relative" ||
        ...
        E["sug" + T.sugId] = baidu.suggestion.create(
            T,
            J.createSugOptions(T.sugId, Z, S, X ? N(T) : null)
        );
    ...
    function A() {
        L(
            ".bdSug_wpr",
            "line-height:normal;background:#FFF;padding:0;margin:0;border:1px solid #817F82;position:absolute;z-index:9999;"
        );
        L(
            ".bdSug_wpr table",
        ...
        L(
            ".bdSug_wpr td",
            "padding:2px;margin:0;text-align:left;vertical-align:middle;font:14px verdana;font-weight:normal;text-decoration:none;text-indent:0"
        );
    ...
    for (var K = 0, F = H.length; K < F; K++) {
        ...
        if (
            M &&
            M.type == "text" &&
            (M.getAttribute("baiduSug") == 1 || M.getAttribute("baiduSug") == 2)
        ) {
            M.sugId = K;
